function [mres,alphares,muttime,meanswBG,meanswGB,randomG]=Evol_Dynamics_Mass_Alpha_Switching_Gillespie(m0,alpha0,A,M,T,C,betaB,betaG,lambdaGB,lambdaBG,mu,NEVOL,f0,delta)
