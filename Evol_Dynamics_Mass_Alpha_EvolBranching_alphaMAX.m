function [CellArray,CellArray2,f,mstrains,alphastrains,alphares,mres]=Evol_Dynamics_Mass_Alpha_EvolBranching_alphaMAX(m0,alpha0,f0,A,M,T,C,beta,mu,delta,NEVOL,alphamax)
