...
A=100; M=1; T=1; C=0; beta1=1; beta2=1; lambda21=0; lambda12=0; mu=0.0005; delta=0.005; NEVOL=8000; f0=0.002; m0=0.25; alpha0=0; 
...
save('Data_files\FigS7\m.mat','m');
save('Data_files\FigS7\alpha.mat','alpha');
save('Data_files\FigS7\StrainsData_m.mat','StrainsData_m');
save('Data_files\FigS7\StrainsData_alpha.mat','StrainsData_alpha');