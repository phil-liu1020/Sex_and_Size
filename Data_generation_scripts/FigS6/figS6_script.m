...
cd Data_generation_scripts/FigS6
...
save('Data_files\FigS6\genotypesData_m.mat','genotypesData_m');
save('Data_files\FigS6\genotypesData_alpha.mat','genotypesData_alpha');
