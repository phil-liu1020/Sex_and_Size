...
mstrains=[0,0.3,0.305]; alphastrains=[0,0.1,0.1]; S=2; beta1=4; beta2=0.01; lambda12=13/222; lambda21=1/6; C=0.7; G=600; T=0.1; A=100; M=10; f=[0.998,0.002]; stochastic=0;
