function Invtraj=Plotting_Invasion_dynamics_SwitchingEnv(mstrains,alphastrains,S,betaB,betaG,lambdaGB,lambdaBG,C,G,T,A,M,f,stochastic)
...
[g,f]=Plotting_Invasion_dynamics(mstrains,alphastrains,S,betaG,C,tnext,T,A,M,f);
...
[g,f]=Plotting_Invasion_dynamics(mstrains,alphastrains,S,betaB,C,tnext,T,A,M,f);
Invtraj(tinc+1:tnext+tinc)=g(2,:);
tinc=tinc+tnext;
Good=1; Bad=0;
end
